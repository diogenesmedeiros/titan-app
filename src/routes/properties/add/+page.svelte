		...
		<form on:submit={addProductHandlerSubmit} class="row g-3">			  
			...
			<div class="col-md-6">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" id="username_instagram" bind:value={username_instagram} aria-describedby="whatsappHelp">
				</div>
				<div id="whatsappHelp" class="form-text">Deixe uma forma de contato.</div>
			</div>
			<div class="col-md-6">
				<label for="whatsapp_link" class="form-label">Seu numero de whatsapp</label>
				<div class="input-group">
					<span class="input-group-text">
					...
					<input type="text" class="form-control" id="whatsapp_link" bind:value={whatsapp_link} aria-describedby="whatsappHelp">
				</div>
				<div id="whatsappHelp" class="form-text">Deixe uma forma de contato.</div>
			</div>
