...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let userData = [];
  return `${$$result.head += `<!-- HEAD_svelte-1e15859_START -->${$$result.title = `<title>Home</title>`, ""}<meta name="description" content="Svelte demo app"><!-- HEAD_svelte-1e15859_END -->`, ""} ${userData.length > 0 ? `<ul>${each(userData, (user) => {
